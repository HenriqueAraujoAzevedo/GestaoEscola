...
public class AlunoDAO {
	...
	public String Cadastrar(Aluno aluno) throws SQLException {
		...
		// String sql = "INSERT INTO Aluno (Nome, CPF, Matricula, Endereco, Telefone)
		// VALUES (?, ?, ?, ?, ?);";
	...
	public String Editar(Aluno aluno) throws SQLException {
		...
		// String sql = "UPDATE Aluno SET Nome = ?, CPF = ?, Matricula = ?, Endereco =
		// ?, Telefone = ? WHERE Id = ?;";
	...
	public List<Aluno> Listar() throws SQLException {
		...
		try {
			...
			// String query = "SELECT Id, Nome, CPF, Matricula, Endereco, Telefone FROM
			// Aluno;";
	...
	public List<Aluno> Filtrar(String nome, String cpf, String matricula) throws SQLException {
		...
		try {
			...
			// String query = "SELECT id, nome, cpf, matricula, Endereco, Telefone FROM
			// Aluno WHERE nome = ? or cpf = ? or matricula = ?;";
